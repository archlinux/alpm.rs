...
>;
#[doc = " Total Download callback."]
#[doc = " @param howmany the number of packages that will be downloaded during \\link alpm_trans_commit \\endlink."]
#[doc = " @param total amount that will be downloaded during \\link alpm_trans_commit \\endlink."]
pub type alpm_cb_totaldl =
    ::std::option::Option<unsafe extern "C" fn(howmany: usize, total: off_t)>;
...
extern "C" {
    ...
    #[doc = " @param handle the context handle"]
    #[doc = " @return the currently set total download callback"]
