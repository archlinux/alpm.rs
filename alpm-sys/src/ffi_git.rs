...
#[test]
fn bindgen_test_layout_alpm_download_event_init_t() {
    assert_eq!(
        ::std::mem::size_of::<alpm_download_event_init_t>(),
        4usize,
        concat!("Size of: ", stringify!(alpm_download_event_init_t))
    );
    assert_eq!(
        ::std::mem::align_of::<alpm_download_event_init_t>(),
        4usize,
        concat!("Alignment of ", stringify!(alpm_download_event_init_t))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<alpm_download_event_init_t>())).optional as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(alpm_download_event_init_t),
            "::",
            stringify!(optional)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct alpm_download_event_progress_t {
    pub downloaded: off_t,
    pub total: off_t,
}
#[test]
fn bindgen_test_layout_alpm_download_event_progress_t() {
    assert_eq!(
        ::std::mem::size_of::<alpm_download_event_progress_t>(),
        16usize,
        concat!("Size of: ", stringify!(alpm_download_event_progress_t))
    );
    assert_eq!(
        ::std::mem::align_of::<alpm_download_event_progress_t>(),
        8usize,
        concat!("Alignment of ", stringify!(alpm_download_event_progress_t))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<alpm_download_event_progress_t>())).downloaded as *const _
                as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(alpm_download_event_progress_t),
            "::",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<alpm_download_event_progress_t>())).total as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct alpm_download_event_completed_t {
    pub total: off_t,
    pub result: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_alpm_download_event_completed_t() {
    assert_eq!(
        ::std::mem::size_of::<alpm_download_event_completed_t>(),
        16usize,
        concat!("Size of: ", stringify!(alpm_download_event_completed_t))
    );
    assert_eq!(
        ::std::mem::align_of::<alpm_download_event_completed_t>(),
        8usize,
        concat!("Alignment of ", stringify!(alpm_download_event_completed_t))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<alpm_download_event_completed_t>())).total as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(alpm_download_event_completed_t),
            "::",
            stringify!(total)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<alpm_download_event_completed_t>())).result as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    ...
    #[doc = " If the function is not called then the default value of '1' stream"]
    #[doc = " (i.e. sequential download) is used."]
    #[doc = " @param handle the context handle"]
...
extern "C" {
    ...
    #[doc = " @param a char* list of servers. Note: the database will"]
...
extern "C" {
    ...
    #[doc = " Example:"]
    #[doc = " @code"]
    #[doc = " alpm_list_t *dbs = alpm_get_syncdbs();"]
...
extern "C" {
    ...
    #[doc = " @param the archive to close"]
...
extern "C" {
    #[doc = " Check for new version of pkg in sync repos"]
    #[doc = " (only the first occurrence is considered in sync)"]
...
extern "C" {
    ...
    #[doc = " @param pkgs an alpm_list_t* of alpm_pkg_t where the satisfier will be searched"]
...
extern "C" {
    ...
    #[doc = " providers. The first satisfier that belongs to an installed package is"]
    ...
    #[doc = ""]
    #[doc = " @param handle the context handle"]
    #[doc = " @param dbs an alpm_list_t* of alpm_db_t where the satisfier will be searched"]
    #[doc = " @param depstring package or provision name, versioned or not"]
    #[doc = " @return a alpm_pkg_t* satisfying depstring"]
...
extern "C" {
    #[doc = " @brief Check the package conflicts in a database"]
    #[doc = ""]
    #[doc = " @param handle the context handle"]
...
extern "C" {
    ...
    #[doc = " in any way."]
    #[doc = " @param myhandle the context handle"]
    #[doc = " @return 0 on success, -1 on error"]
