...
fn bindgen_test_layout___alpm_list_t() {
    const UNINIT: ::std::mem::MaybeUninit<__alpm_list_t> = ::std::mem::MaybeUninit::uninit();
...
fn bindgen_test_layout__alpm_conflict_t() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).package1_hash) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).package2_hash) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_alpm_conflict_t),
